...
% We note this ordering explicitly because our security analysis (\S\ref{sec:security}) 
...
Under strict mode, the attack window spans from DMA completion to IOTLB invalidation completion; as shown in \S\ref{sec:inefficiencies}, this window grows rapidly under lock contention.
...
We highlight this ordering explicitly because our security analysis (\S\ref{sec:security}) 
